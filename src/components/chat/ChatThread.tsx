...
export function ChatThread({ thread }: Props) {
  ...
  const other =
    thread.participants.find((p) => p.id !== myId) ?? thread.participants[0]!;
    ...
    <div className={styles.col}>
      <div className={styles.head}>
        ...
        <div>
          ...
          <div className={styles.ht2}>Direct message</div>
        </div>
      </div>
